	...
	<body>
		<div id="mother">
			<div id="errorBox">
				...
				<a href="${pageContext.request.contextPath }/pages/index.jsp" target="_top" title="返回超时登录页面">
					<div class="link" id="home"></div>
				</a>
				<a href="${pageContext.request.contextPath }/pages/index.jsp" target="_top" title="联系管理员">
