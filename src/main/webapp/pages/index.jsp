...
<div class="main_left">
	...
	<ul class="menu">
		...
		<li>
			...
			<a href="javascript:void(0);" data-id="staff" data-href="staff_List.html">员工列表</a>
		</li>
		<li>
			<i class="menu_icon fa fa-plus-square"></i>
			<a href="javascript:void(0);" data-id="staff" data-href="add_Staff.html">添加员工</a>
		</li>
		<!--会员管理-->
		<li>
			<i class="menu_icon fa fa-user"></i>
			<a href="javascript:void(0);" data-id="user" data-href="user_List.html">本店会员</a>
		</li>
		<li>
			<i class="menu_icon fa fa-user-plus"></i>
			<a href="javascript:void(0);" data-id="user" data-fast="add_user" data-href="add_User.html">添加会员</a>
		</li>
		<li>
			<i class="menu_icon fa fa-vcard"></i>
			<a href="javascript:void(0);" data-id="user" data-href="user_Info.html">会员信息</a>
		</li>
		<!--订单管理-->
		<li>
