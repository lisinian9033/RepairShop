		...
		<script>
			$(function(){
				...
				$(".add_car").click(function(){
					...
					$(".tip_tbox",Wparent).append("<iframe src='order_addCar.html?userId="+userId+"' frameborder='0' width='100%' height='100%' seamless></iframe>");
					DelTipWidth(700,520);
				...
				$(".choose_serve").click(function(){
					if($(".user_have").is(":visible")&&$(".car_row").find(".curr").length<=0){
						...
						$(".tip_tbox",Wparent).append("<iframe src='${pageContext.request.contextPath }/pages/choose_Serve.jsp' frameborder='0' width='100%' height='100%' seamless></iframe>");
						DelTipWidth(700,500);
						var titH = $(".tip_box",Wparent).find("h2").outerHeight();
